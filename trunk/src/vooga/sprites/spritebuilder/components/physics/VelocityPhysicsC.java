 ...
 * 
 */
public class VelocityPhysicsC extends GeneralPhysicsC{
     ...
     * @param mass
     */
    public VelocityPhysicsC(Velocity velocity, double mass) {
        this(velocity, true);
    }
     ...
     * @param isOn
     */
    public VelocityPhysicsC(Velocity velocity, boolean isOn) {
