...
public class ExampleLevel2 extends AbstractLevel
{
    ...
    public ExampleLevel2 (String filePath, int id, CustomPlayField pf, Game game)
    {
    ...
    private void ignoreThis ()
    {
        ...
        aliens.add(new VerticalBounceAlien(new BasicAlien(100,200,1,myGame,myPlayField)));
        aliens.add(new VerticalBounceAlien(new BasicAlien(300,200,1,myGame,myPlayField)));
        aliens.add(new VerticalBounceAlien(new BasicAlien(200,500,1,myGame,myPlayField)));
