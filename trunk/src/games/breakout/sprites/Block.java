...
//    }
     ...
     */
    public Block(BufferedImage image, int x, int y, int c)
    {
        this(image, x, y, c, 1);
    }
     ...
     */
    public Block(BufferedImage image, int x, int y, int c, int hp)
    {
        super(image, 1 + x * (2 + image.getWidth()), 1 + y * (2 + image.getHeight()));
        
        setImage(Breakout.imageLoader.getImage("block", c));
        this.hp = hp;
