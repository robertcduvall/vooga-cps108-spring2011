...
public class VelocityC extends HeadingC implements ISpriteUpdater{

	protected Double myMagnitude;
	protected Double oldAngle;

	public VelocityC(Double mag, Double dir){
		super(dir);
		myMagnitude = mag;
		oldAngle = myAngle;
	}
	...
	protected int compareTo(BasicComponent o) {
		return ((Double)this.getMagnitude()).compareTo((Double)((VelocityC) o).getMagnitude());
	}
