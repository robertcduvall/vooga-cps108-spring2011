 ...
 *
 */
public class TestGravityBehavior {

    @Test
    public void testGravitationalForce(){
        AbstractPhysicsC basic = new PhysicsVelocityC();
        //Velocity of 0, mass of 1
        AbstractForceGenerator force = new MassProportionalForceGenerator(new Force(10,new Angle(Math.PI)));
